# helper functions for cluster submissions. Built on StyleGAN-2.
import copy
import inspect
import os
import pathlib
...
def submit_run(submit_config: SubmitConfig, run_func_name: str, create_newdir: bool = False,
    ...
    print(submit_config.user_name, submit_config.run_id, submit_config.run_desc)
    submit_config.task_name = "{}-{}-{}".format(str(submit_config.user_name), str(submit_config.run_id), str(submit_config.run_desc))
