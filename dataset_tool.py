# Script to generate multi- or single-coil datasets mainly built on Stylegan-2.
import sys
import glob
import argparse
import threading
...
def display(tfrecord_dir):
    ...
    while True:
        ...
        np.save('/auto/k2/korkmaz/ex_im.png',images)
        print('necessary: ' + str(images.shape))
    ...
    with h5py.File(hdf5_filename, 'r') as hdf5_file:
        ...
        with TFRecordExporter(tfrecord_dir, hdf5_data.shape[0]) as tfr:
            ...
            for idx in range(order.size):
                ...
                # third channel: dummy channel containing ones
                tfr.add_image_float(np.stack([real,imag,ones],axis=0 ))
